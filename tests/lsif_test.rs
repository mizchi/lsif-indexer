...
fn test_generate_lsif_with_documentation() {
    ...
    let mut func1 = create_test_symbol("func1", "documented_function", SymbolKind::Function, "/src/doc.rs");
...
fn test_write_lsif() {
    let mut graph = CodeGraph::new();
    let symbol = create_test_symbol("write_test", "test_write", SymbolKind::Function, "/write.rs");
