use lsif_indexer::core::{
    ...
    QueryParser, QueryEngine, QueryPattern, format_query_results,
};
...
fn create_complex_graph() -> CodeGraph {
    ...
    let user_model = Symbol {
        ...
        range: Range {
            start: Position { line: 0, character: 0 },
            end: Position { line: 100, character: 1 },
        },
    ...
    let admin_model = Symbol {
        ...
        range: Range {
            start: Position { line: 0, character: 0 },
            end: Position { line: 150, character: 1 },
        },
    ...
    let user_service = Symbol {
        ...
        range: Range {
            start: Position { line: 0, character: 0 },
            end: Position { line: 200, character: 1 },
        },
    ...
    let save_to_db = Symbol {
        ...
        range: Range {
            ...
            end: Position { line: 80, character: 1 },
        },
    ...
    let save_method = Symbol {
        ...
        range: Range {
            ...
            end: Position { line: 40, character: 5 },
        },
    ...
    let validate_method = Symbol {
        ...
        file_path: "models/user.rs".to_string(),
        range: Range {
            start: Position { line: 50, character: 4 },
            end: Position { line: 60, character: 5 },
        },
...
fn test_complex_inheritance_chain() {
    ...
    let pattern = QueryParser::parse("(admin:Class)-[:Definition|Implementation*1..3]->(trait:Interface)").unwrap();
    ...
    let has_admin_to_trait = results.matches.iter().any(|m| {
        m.bindings.iter().any(|(v, s)| v == "admin" && s.name == "AdminModel") &&
...
fn test_method_to_function_references() {
    ...
    let method_names: HashSet<String> = results.matches.iter()
