...
mod tests {
    ...
    fn test_build_with_edges() {
        ...
        // エッジを追加
        builder.add_edge_by_id("sym1".to_string(), "sym2".to_string(), EdgeKind::Reference)
    ...
    fn test_build_with_invalid_edges() {
        ...
        // 存在しないシンボルへのエッジを追加
        builder.add_edge_by_id("sym1".to_string(), "nonexistent".to_string(), EdgeKind::Reference)
               .add_edge_by_id("nonexistent".to_string(), "sym1".to_string(), EdgeKind::Reference);
    ...
    fn test_method_chaining() {
        let mut builder = GraphBuilder::new();
        builder.add_symbol(create_test_symbol("a", "A"))
