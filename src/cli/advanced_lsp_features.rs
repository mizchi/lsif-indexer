...
impl AdvancedLspClient {
    ...
    /// コールヒエラルキーの準備
    pub fn prepare_call_hierarchy(&self, params: CallHierarchyPrepareParams) 
    ...
    /// 呼び出し元を取得
    pub fn incoming_calls(&self, params: CallHierarchyIncomingCallsParams) 
    ...
    /// 呼び出し先を取得
    pub fn outgoing_calls(&self, params: CallHierarchyOutgoingCallsParams) 
    ...
    /// 型階層の準備
    pub fn prepare_type_hierarchy(&self, params: TypeHierarchyPrepareParams) 
    ...
    /// スーパータイプを取得
    pub fn type_hierarchy_supertypes(&self, params: TypeHierarchySupertypesParams) 
        -> Result<Option<Vec<TypeHierarchyItem>>> {
        let mut client = self.client.lock().unwrap();
    ...
    /// サブタイプを取得
    pub fn type_hierarchy_subtypes(&self, params: TypeHierarchySubtypesParams) 
        -> Result<Option<Vec<TypeHierarchyItem>>> {
        let mut client = self.client.lock().unwrap();
    ...
    /// ドキュメントハイライトを取得
    pub fn document_highlight(&self, params: DocumentHighlightParams) 
    ...
    /// ドキュメントリンクを取得
    pub fn document_link(&self, params: DocumentLinkParams) 
    ...
    /// コードレンズを取得
    pub fn code_lens(&self, params: CodeLensParams) 
    ...
    /// ドキュメントカラーを取得
    pub fn document_color(&self, params: DocumentColorParams) 
    ...
    /// カラープレゼンテーションを取得
    pub fn color_presentation(&self, params: ColorPresentationParams) 
    ...
    /// フォーマットを実行
    pub fn formatting(&self, params: DocumentFormattingParams) 
    ...
    /// 範囲フォーマットを実行
    pub fn range_formatting(&self, params: DocumentRangeFormattingParams) 
        -> Result<Option<Vec<TextEdit>>> {
        let mut client = self.client.lock().unwrap();
    ...
    /// 型フォーマットを実行
    pub fn on_type_formatting(&self, params: DocumentOnTypeFormattingParams) 
        -> Result<Option<Vec<TextEdit>>> {
        let mut client = self.client.lock().unwrap();
    ...
    /// リネーム準備
    pub fn prepare_rename(&self, params: TextDocumentPositionParams) 
    ...
    /// 折りたたみ範囲を取得
    pub fn folding_range(&self, params: FoldingRangeParams) 
    ...
    /// 選択範囲を取得
    pub fn selection_range(&self, params: SelectionRangeParams) 
    ...
    /// セマンティックトークンを取得（フル）
    pub fn semantic_tokens_full(&self, params: SemanticTokensParams) 
    ...
    /// セマンティックトークンを取得（差分）
    pub fn semantic_tokens_full_delta(&self, params: SemanticTokensDeltaParams) 
    ...
    /// セマンティックトークンを取得（範囲）
    pub fn semantic_tokens_range(&self, params: SemanticTokensRangeParams) 
    ...
    /// ワークスペースシンボルを取得
    pub fn workspace_symbol(&self, params: WorkspaceSymbolParams) 
    ...
    /// 実装へジャンプ
    pub fn goto_implementation(&self, params: GotoImplementationParams) 
    ...
    /// 型定義へジャンプ
    pub fn goto_type_definition(&self, params: GotoTypeDefinitionParams) 
    ...
    /// 宣言へジャンプ
    pub fn goto_declaration(&self, params: GotoDeclarationParams) 
...
impl DiagnosticsWatcher {
    ...
    pub async fn run(mut self) {
        while let Some(params) = self.rx.recv().await {
            ...
            self.client.update_diagnostics(params.uri, params.diagnostics);
        }
    }
}
...
impl LspCodeAnalyzer {
    ...
    pub fn get_symbol_info(&self, uri: &Url, position: Position) -> Result<SymbolInfo> {
        ...
        let definition = self.client.client.lock().unwrap().goto_definition(
        ...
        let references = self.client.client.lock().unwrap().find_references(
            ReferenceParams {
...
mod tests {
    use super::*;
    use crate::cli::lsp_adapter::RustAnalyzerAdapter;
